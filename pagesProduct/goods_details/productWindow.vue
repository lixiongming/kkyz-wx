...
<script setup>
 	import { ref, computed, watch, onMounted, markRaw, getCurrentInstance, defineProps, nextTick } from "vue";
	...
	const emits = defineEmits(['goCat','myevent','attrVal','ChangeAttr'])
	...
	function getpreviewImage() {
		uni.previewImage({
			urls: props.attr.productSelect.image.split(','),
			current: props.attr.productSelect.image
		});
	}
