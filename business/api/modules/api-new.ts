...
export function setCouponReceive(couponId) {
  return request.post("mall/coupon/receive/" + couponId);
}
/**
 * 商铺优惠券列表
 * @param object data
...
export function getShopCoupons(id) {
  return request.get("mall/coupon/store/" + id, {}, { noAuth: true });
}
/**
 * 商品优惠券列表
 * @param object data
...
export function getCoupons(data) {
  return request.get("mall/coupon/product", data, { noAuth: true });
}
/**
 * 我的优惠券
...
/**
 * @description :  重置支付密码-发送验证码,修改人: 吴
 * @createTime : 2023-12-15 20:26:38
 */
export function registerVerify(phone, reset, key, code) {
  return request.post(
    "auth/verify",
...
// 小程序商城 - 获取城市列表
export function getCityV2Api(data) {
  return request.get("mall/address/city", data, { noAuth: true });
}
export function getCityList(address) {
  return request.get("v2/system/city", { address }, { noAuth: true });
}
// 小程序商城 - 地址转换
export function getCityListApi(address) {
  return request.get("mall/address/getCityList", { address }, { noAuth: true });
}
/** 获取小程序直播列表 */
...
/**
 * @description :  获取APP的版本更新记录,,修改人: 吴，接口todo
 * @createTime : 2023-12-13 20:08:25
 */
export function getVersionLst(data) {
  return request.get("banben_update_lst", data, {
    noAuth: true,
  });
}

// 检验商城登录状态
export function getAuthMiddleVerify(data) {
  return request.post(`auth/middle/verify`, data);
}

// 检验商城登录状态v2(middle_token 续期及账号是否被挤)
export function getAuthMiddleRefresh(data) {
  return request.post(`auth/middle/refresh`, data);
}

// 小程序商城 - 用户界面统计收益
export function getTicketTotalApi(data) {
  return request.get(`mall/common/ticketTotal`, data);
}

// 小程序商城 - 用户界面预期收益
export function getExpectTicketApi(data) {
  return request.get(`mall/common/expectTicket`, data);
}

// 小程序商城 - 用户邀请明细列表
export function getInviteListTicketApi(data) {
  return request.get(`mall/earnings/inviteList`, data);
}

// 小程序商城 - 用户购物佣金列表
export function getShoppingListTicketApi(data) {
  return request.get(`mall/earnings/shopping`, data);
}

// 小程序商城 - 用户推广佣金列表
export function getPromotionListTicketApi(data) {
  return request.get(`mall/earnings/promotion`, data);
}

// 小程序商城 - 带货佣金
export function getEarningsSellApi(data) {
  return request.get(`mall/earnings/sell`, data);
}
