...
export function getCartList() {
  return request.get("mall/cart/lst");
}
...
export function changeCartNum(cartId, data) {
  return request.post("mall/cart/change/" + cartId, data);
}
/**
 * 清除购物车
 * @param object ids
...
export function cartDel(data) {
  return request.delete("mall/cart/delete", data);
}
/**
 * 订单列表
 * @param object data
...
export function getOrderConfirm(data) {
  return request.post("mall/order/check", data);
}
/**
 * 校验进货商品订单
 */
...
export function createOrder(data) {
  return request.post("mall/order/create", data, { noAuth: true });
}
// 获取订单状态
export function orderStatus(data) {
  return request.get("mall/order/status",data);
}
// 提交进货商品订单
