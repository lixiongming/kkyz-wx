...
export function getUserInfo() {
  return request.get("mall/common/userInfo");
}
 ...
 * @param int data
 */
export function setAddressDefaultApi(data) {
  return request.post("mall/address/setDefault", data);
}
/**
 * 修改 添加地址
 * @param object data
...
export function editAddressApi(data) {
  return request.post("mall/address/save", data);
}
/**
 * 删除地址
 * @param int id
...
export function delAddressApi(data) {
  return request.delete("mall/address/del", data);
}
/**
 * 获取单个地址
 * @param int id
...
export function getAddressDetail(data) {
  return request.get("mall/address/detail",data);
}
/**
 * 小程序商城 - 获取单个地址
 * @param object data
...
export function serviceList(data) {
  return request.get("mall/service/list", data);
}
/**
 * 客服列表
 */
...
export function getChatRecord(data) {
  return request.get("mall/service/history", data);
}
/**
 * 客服获取聊天记录详情
 */
 ...
 * 小程序商城 - 反馈类型
 */
export function feedbackTypeApi() {
  return request.get("mall/feedback/type");
}
/**
 * 提交反馈
 */
 ...
 * 提交反馈
 */
export function feedbackSaveApi(data) {
  return request.post("mall/feedback/submit", data);
}
/**
 * 反馈列表
 */
...
export function feedbackListApi(data) {
  return request.get("mall/feedback/list", data);
}
/**
 * 反馈列表
 */
 ...
 * 小程序商城 - 反馈列表
 */
export function feedbackDetailApi(data) {
  return request.get("mall/feedback/details", data);
}
/**
 * 浏览记录
 */
export function historyList(data) {
  return request.get("mall/user/history/list", data);
}
/**
 * 删除浏览记录
 */
...
export function historyBatchDelete(data) {
  return request.post("mall/user/history/remove", data);
}
/**
 * 批量收藏浏览记录
 */
...
// 小程序商城 - 创建发票
export function invoiceSaveApi(data) {
  return request.post("mall/receipt/create", data);
}
// 编辑发票
...
export function invoice(data) {
  return request.get("mall/receipt/list", data);
}
// 发票抬头--列表
...
// 小程序商城 - 发票详情
export function invoiceDetailApi(data) {
  return request.get("mall/receipt/detail", data);
}
/**
 * 新版分享海报信息获取
 *
 ...
 *
 */
export function hasServiceApi(data) {
  return request.get(`mall/service/hasService`,data);
}
/**
 * 小程序商城 - 客服聊天-判断店铺是否有在线客服
 * @param object data
 *
 */
export function hasOnlineServiceApi(data) {
  return request.get(`mall/service/hasService`, data);
}
/**
 * 银行卡提现--银行卡信息
...
export function getNoticeListApi(data) {
	return request.get('mall/user/notice/list', data, {
		noAuth: true
	})
}
