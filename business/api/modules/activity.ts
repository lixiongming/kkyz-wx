...
export function getActivitycategory(type) {
  return request.get(
    "product/spu/active/category/" + type,
    {},
    {
      noAuth: true,
    }
 ...
 * 获取本地服务商户列表
 */
export function getLocalMerchantList(data) {
  return request.get(`store/merchant/local/lst`, data, {
    noAuth: true,
  });
}
/**
...
export function spuTop(data) {
  return request.get(
    `store/product/category/hotranking`,
    {},
    {
      noAuth: true,
    }
...
export function getWelfareList(data) {
  return request.get(`welfare/post/local`, data, {
    noAuth: true,
  });
}
/**
 * 本地生活获取置顶店铺信息
 */
export function getTopMerchant(data) {
  return request.get(`local/merchant/getTopMerchant`, data, {
    noAuth: true,
  });
}
/**
 * 设置置顶
 */
export function merchantSetTop(data) {
  return request.post(`local/merchant/setTop`, data, {
    noAuth: true,
  });
}
/**
 * 取消置顶
 */
export function merchantCancelTop(data) {
  return request.post(`local/merchant/cancelTop`, data, {
    noAuth: true,
  });
}
/**
 * 首页获取置顶店铺信息
 */
export function getHomeTopMerchant() {
  return request.get(`local/merchant/getHomeTopMerchant`, {
    noAuth: true,
  });
}
/**
 * 首页获取置顶商品信息-分页
 */
export function getspumerchant(mer_id, data) {
  return request.get(`product/spu/merchant/${mer_id}`, data, {
    noAuth: true,
  });
}
