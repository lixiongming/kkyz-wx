<template>
	...
	<view>
		...
		<view v-else class="list-null"><text class="text">暂无直播</text></view>
	</view>
	<!-- #endif -->
</template>
...
<script>
	...
	import {getLiveData} from '@/business/api/modules/mall.ts';
	...
	export default {
		...
		data() {
			console.log("live---dataConfig----->", this.dataConfig)
			return {
