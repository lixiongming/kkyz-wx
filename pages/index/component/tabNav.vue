<template>
	<view>
		...
		<view class="navTabBox tabNav" :class="{isFixed:isFixed}" :style="'background:  '+ bgColor +';margin-top:'+mbConfig+'rpx;color:'+txtColor+';top:'+isTop">		
			...
			<navigator v-if="merId" :url="'/views/pages/home/store?mer_id='+merId+'&type=2'" class="category" hover-class="none" :style="'background-color:'+bgColor+';color:'+txtColor">
				<!-- <text class="iconfont icon-fenlei3"></text> -->
				<text>分类</text>
				<image src="/static/images/fenlei-bs.png" style="width: 11px;height: 22rpx; margin-left: 8rpx;"></image>
			</navigator>
			...
			longClick(index,id,fid){
				...
				if(!this.merId){
					...
					if(id){
						...
						uni.navigateTo({
							url: '/views/pages/home/store?mer_id='+this.merId
						});
					}
