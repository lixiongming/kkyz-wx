<template>
	...
	<view>
		...
		<!-- <view class="mall-mask" @touchmove.prevent :hidden="specsInfo.show === false" @click="closeSpecs"></view> -->
		<view class="mall-mask" @touchmove.prevent v-if="specsInfo.show" @click="closeSpecs"></view>
	</view>
</template>
