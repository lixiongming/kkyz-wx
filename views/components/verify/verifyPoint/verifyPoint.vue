<template>
	<view style="position: relative">
		<view class="verify-image-out" v-if="showImage">
			<view class="verify-image-panel" :style="{'width': imgSize.width,
                                                   'height': imgSize.height,
                                                   'margin-bottom': vSpace + 'px'}">
				<view class="verify-refresh" style="z-index:3" @click="refresh" v-if="showRefresh">
    ...
    export default {
        ...
        methods: {
                ...
                query.select('#image').boundingClientRect(data => {
                    ...
                    if (this.num == this.checkNum) {
                        ...
                        setTimeout(() => {
                            ...
                            mineApi.ajcaptchaCheck(data).then(result => {
                                let res = result.data
            ...
            getPictrue(){
                ...
                mineApi.getAjcaptcha(data).then((result) => {
                    let res = result.data
...
<style scoped>
	...
	.icon-check:before {
		...
		bottom: 0;
		z-index: 9999;
		background-image: url("https://kankan-cdn.mdd3.cn/images/kkyz/arrow-good.png");
	...
	.icon-close:before {
		...
		bottom: 0;
		z-index: 9999;
		background-image: url("https://kankan-cdn.mdd3.cn/images/kkyz/arrow-close.png");
		background-size: contain;
	}
	...
	.icon-right:before {
		...
		z-index: 9999;
		background-image: url("https://kankan-cdn.mdd3.cn/images/kkyz/arrow-right.png");
		background-size: contain;
	}
	...
	.icon-refresh:before {
		...
		bottom: 0;
		z-index: 9999;
		background-image: url("https://kankan-cdn.mdd3.cn/images/kkyz/refresh.png");
		background-size: contain;
	}
</style>
